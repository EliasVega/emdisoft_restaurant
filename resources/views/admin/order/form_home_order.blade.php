<div class="box-body row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="addName">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="addAddress">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="addPhone">
        <div class="form-group">
