<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="payBalanceOld">
        <div class="form-group">
            ...
            <input type="text" name="balance_old" id="balance_old" value="{{ old('balance_old', $order->balance ?? '') }}" class="form-control" placeholder="Codigo del product" readonly>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="payInvoice">
        <div class="form-group">
            <label for="pay_order">Pagos Factura</label>
            <input type="text" name="pay_order" id="pay_order" value="{{ old('pay_order', $payOrders ?? '') }}" class="form-control" placeholder="Codigo del product" readonly>
        </div>
    </div>
