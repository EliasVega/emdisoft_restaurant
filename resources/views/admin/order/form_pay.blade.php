<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-3 col-sm-3 col-xs-12">
        <div class="form-group">
            <button class="btn btn-celeste btn-sm" type="button" id="prepay" data-toggle="tooltip" data-placement="top" title="Anticipo">P/Anticipado</button>
        </div>
    </div>
    <div class="col-lg-4 col-md-3 col-sm-3 col-xs-12">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" id="payPay">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" id="payAdvance">
        <div class="form-group">
            <label class="form-control-label requerido" for="advance">abono anticipado</label>
            <input type="number" id="advance" name="advance"
                class="form-control blanco">
        </div>
    </div>
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" id="payVadvance">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" id="payTransaction">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" id="payBank">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" id="payCard">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="payAdvanceId">
        <div class="form-group">
