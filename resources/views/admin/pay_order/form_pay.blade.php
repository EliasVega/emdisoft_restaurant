<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="number" id="balance" name="balance" value="{{ $orders->balance }}" class="form-control gris" disabled pattern="[0-9]{0,15}">
        </div>
    </div>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div class="form-group">
            ...
            <a href="{{url('pay_order')}}" class="btn btn-gris"><i class="fa fa-window-close"></i>&nbsp; Cancelar</a>
        </div>
    </div>
