        ...
        <select id="customer_id" name="customer_id" class="form-control selectpicker" data-live-search="true" required>
            ...
            @foreach($customers as $customer)
                @if($customer->id == ($advance->customer_id ?? ''))
                    <option value="{{ $customer->id }}" selected>{{ $customer->nit }} -- {{ $customer->name }}</option>
                @else
...
<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" id="banky">
    <div class="form-group">
...
<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" id="cardy">
    <div class="form-group">
...
<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" id="transactiony">
    <div class="form-group">
