    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Editar Tributo:</h3>
            </div>
            @if (count($errors)>0)
                ...
                <div class="box-body row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="code" class="form-control" value="{{ $tax->code }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label for="description">Descripcion tributo</label>
                            <input type="text" name="description" class="form-control" value="{{ $tax->description }}">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
