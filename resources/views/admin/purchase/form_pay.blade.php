<div class="box-body row">
    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 mt-3" id="fpay">
    ...
    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 mt-3" id="mpay">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="addPays">
        <div class="form-group">
