    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Editar Forma de Pago:&nbsp;&nbsp;&nbsp;&nbsp;  {{ $payment_form->name }}</h3>
            </div>
            @if (count($errors)>0)
            ...
            @endif
            {!!Form::model($payment_form, ['method'=>'PATCH','route'=>['payment_form.update', $payment_form->id]])!!}
            {!!Form::token()!!}
                <div class="box-body row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $payment_form->name }}">
                        </div>
                    </div>
